...
const Contact = () => (
  <main className="bg3">
    <div className="container connect-wrapper">
      <div className="row">
        <h3 className="col-12 connect" style={{ fontSize: "260%" }}>Let's Connect!</h3>
          ...
          <div className="col">
            <form>
              <div className="form-group row">
                  <label htmlFor="inputName" className="col-sm-2 form-control-label text-sm-right">Gina Marie Enriquez</label>
                  <div className="col-sm-8">
                      <input type="text" className="form-control" id="inputName" placeholder="Name"/>
                  </div>
              </div>
              <div className="form-group row">
                  <label htmlFor="inputEmail" className="col-sm-2 form-control-label text-sm-right">ginamarieconnections@gmail.com</label>
                  <div className="col-sm-8">
